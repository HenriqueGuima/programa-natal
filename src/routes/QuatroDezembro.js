...
import data from "../data/quatrodezembro.json";
import imagem from "../assets/imagens/Imagem_10.jpg";
import FooterEventComponent from "../components/FooterEventComponent";
import dataEvents from "../data/quatrodezembroeventos.json";
import HeaderEventComponent from "../components/HeaderEventComponent";

export default function QuatroDezembro() {
  return (
    <React.Fragment>
