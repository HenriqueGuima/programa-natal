...
import data from "../data/seisdezembro.json";
import imagem from "../assets/imagens/Imagem_01.jpg";
import FooterEventComponent from "../components/FooterEventComponent";
import dataEvents from "../data/seisdezembroeventos.json";
import HeaderEventComponent from "../components/HeaderEventComponent";

export default function SeisDezembro() {
  return (
    <React.Fragment>
