...
import data from "../data/setedezembro.json";
import imagem from "../assets/imagens/Imagem_13.jpg";
import FooterEventComponent from "../components/FooterEventComponent";
import dataEvents from "../data/setedezembroeventos.json";
import HeaderEventComponent from "../components/HeaderEventComponent";

export default function SeteDezembro() {
  return (
    <React.Fragment>
