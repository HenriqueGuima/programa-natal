...
import data from "../data/umdezembro.json";
import imagem from "../assets/imagens/Imagem_05.jpg";
import FooterEventComponent from "../components/FooterEventComponent";
import dataEvents from "../data/umdezembroeventos.json";
import HeaderEventComponent from "../components/HeaderEventComponent";

export default function UmDezembro() {
  return (
    <React.Fragment>
