...
import dataEvents from "../../data/outrostipos.json";
import HeaderEventComponent from "../../components/HeaderEventComponent";

export default function OutrosTipos() {
  return (
    <React.Fragment>
              ...
              return (
                <React.Fragment>
                  <div className="row evento-dia m-2" key={evento.id}>
                    <h1 className="titulo_evento_preto mt-2">
                      {evento.tituloPreto}
                    </h1>
                    ...
                    <span className="hora_evento">{evento.por}</span>
                    <div className="mt-2"></div>
                    <span className="hora_evento">{evento.hora}</span>
                    <span className="local_evento">{evento.local}</span>
                    <div className="mt-2"></div>
                    {/* <div className=" evento-dia m-2">
                      <span className="local_evento">{evento.encontro}</span>{" "}
