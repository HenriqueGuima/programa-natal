...
import data from "../data/doisjaneiro.json";
import imagem from "../assets/imagens/Imagem_41.JPG";
import FooterEventComponent from "../components/FooterEventComponent";
import dataEvents from "../data/cincodezembroeventos.json";
import HeaderEventComponent from "../components/HeaderEventComponent";

export default function DoisJaneiro() {
  return (
    <React.Fragment>
